...
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#27#29", Main.var"#28#30"})
...
precompile(Tuple{typeof(Base.findfirst), Main.var"#31#32", Dictionaries.Dictionary{Base.UUID, Lava.PhysicalBuffer}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#33#34", Array{Vulkan.ImageMemoryBarrier2, 1}})
precompile(Tuple{typeof(Base.all), Base.Generator{Array{Vulkan.ImageMemoryBarrier2, 1}, Main.var"#33#34"}})
...
precompile(Tuple{Main.var"#35#38"{Lava.LogicalAttachment, Lava.LogicalImage, Lava.LogicalAttachment}, Lava.CompactRecord})
...
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#36#39"{Lava.BakedRenderGraph, Dictionaries.Dictionary{Lava.ProgramInstance, UInt64}, Array{Lava.CompactRecord, 1}}, Main.var"#37#40"})
...
precompile(Tuple{Main.var"#42#43"{Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.save_test_render), String, Base.ReshapedArray{ColorTypes.RGBA{Float16}, 2, Base.ReinterpretArray{ColorTypes.RGBA{Float16}, 1, UInt8, Array{UInt8, 1}, false}, Tuple{}}, UInt64})
precompile(Tuple{typeof(Main.program_2), Lava.Device, Array{NTuple{4, Float32}, 1}, Lava.PhysicalAttachment})
precompile(Tuple{Main.var"#44#45"{Lava.Device, Array{NTuple{4, Float32}, 1}, Lava.PhysicalAttachment, Tuple{Float32, Float32}}, Lava.CompactRecord})
...
precompile(Tuple{Main.var"#46#47"{Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#48#52"{XCB.XCBWindow}, Main.var"#49#53"})
precompile(Tuple{typeof(Main.xcb_surface), Lava.Instance, XCB.XCBWindow})
...
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, Main.var"#cycle_f#54", Float64})
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#50#56"{Main.var"#cycle_render#55"{Main.var"#cycle_f#54"}, Lava.FrameCycle{XCB.XCBWindow}}, Main.var"#51#57"})
precompile(Tuple{typeof(Main.render_rectangle), Lava.Device, Lava.ImageWSI, Tuple{Float32, Float32}})
...
precompile(Tuple{Main.var"#cycle_render#55"{Main.var"#cycle_f#54"}, Lava.FrameCycle{XCB.XCBWindow}, Float64})
...
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"##render_file#22"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"##save_test_render#41"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#23#25"{f, test, val} where val where test where f}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#24#26"{f, val} where val where f}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#27#29"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#28#30"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#31#32"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#33#34"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#35#38"{depth, normal, color} where color where normal where depth}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#36#39"{baked, pipeline_hashes, records} where records where pipeline_hashes where baked}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#37#40"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#42#43"{device, vdata, color} where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#44#45"{device, vdata, color, uv} where uv where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#46#47"{device, vdata, color} where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#48#52"{win} where win}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#49#53"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#50#56"{cycle_render, cycle} where cycle where cycle_render}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#51#57"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#cycle_f#54"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#cycle_render#55"{cycle_f} where cycle_f}})
...
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Main.var"##render_file#22"})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#22"}, Bool, Function, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#22"}, Bool, Module, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#22"}, Bool, Module, Function, Vararg{Function}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#22"}, Bool, Function, Function})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Main.var"##save_test_render#41"})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#41"}, Bool, Function, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#41"}, Bool, Module, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#41"}, Bool, Module, Function, Vararg{Function}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#41"}, Bool, Function, Function})
...
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#63#65", Main.var"#64#66"})
precompile(Tuple{SPIRV.var"#callback#79"{SPIRV.CodeInstanceCache}, Core.MethodInstance, UInt32})
...
precompile(Tuple{typeof(Base.findfirst), Main.var"#67#68", Dictionaries.Dictionary{Base.UUID, Lava.PhysicalBuffer}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#69#70", Array{Vulkan.ImageMemoryBarrier2, 1}})
precompile(Tuple{typeof(Base.all), Base.Generator{Array{Vulkan.ImageMemoryBarrier2, 1}, Main.var"#69#70"}})
precompile(Tuple{typeof(Main.simple_program), Lava.Device})
precompile(Tuple{Main.var"#71#74"{Lava.LogicalAttachment, Lava.LogicalImage, Lava.LogicalAttachment}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#72#75"{Lava.BakedRenderGraph, Dictionaries.Dictionary{Lava.ProgramInstance, UInt64}, Array{Lava.CompactRecord, 1}}, Main.var"#73#76"})
precompile(Tuple{typeof(Main.program_1), Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment})
precompile(Tuple{Main.var"#78#79"{Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.save_test_render), String, Base.ReshapedArray{ColorTypes.RGBA{Float16}, 2, Base.ReinterpretArray{ColorTypes.RGBA{Float16}, 1, UInt8, Array{UInt8, 1}, false}, Tuple{}}, UInt64})
precompile(Tuple{typeof(Main.program_2), Lava.Device, Array{NTuple{4, Float32}, 1}, Lava.PhysicalAttachment})
precompile(Tuple{Main.var"#80#81"{Lava.Device, Array{NTuple{4, Float32}, 1}, Lava.PhysicalAttachment, Tuple{Float32, Float32}}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.program_3), Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment})
precompile(Tuple{Main.var"#82#83"{Lava.Device, Array{Tuple{Float32, Float32, ColorTypes.RGB{Float32}}, 1}, Lava.PhysicalAttachment}, Lava.CompactRecord})
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#84#88"{XCB.XCBWindow}, Main.var"#85#89"})
precompile(Tuple{typeof(Main.xcb_surface), Lava.Instance, XCB.XCBWindow})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, Main.var"#cycle_f#90", Float64})
precompile(Tuple{typeof(Main.test_validation_msg), Main.var"#86#92"{Main.var"#cycle_render#91"{Main.var"#cycle_f#90"}, Lava.FrameCycle{XCB.XCBWindow}}, Main.var"#87#93"})
precompile(Tuple{typeof(Main.render_rectangle), Lava.Device, Lava.ImageWSI, Tuple{Float32, Float32}})
precompile(Tuple{Main.var"#cycle_render#91"{Main.var"#cycle_f#90"}, Lava.FrameCycle{XCB.XCBWindow}, Float64})
precompile(Tuple{Type{Base.IOContext{IO_t} where IO_t<:IO}, Base.TTY, Pair{Symbol, Array{Tuple{String, Int64}, 1}}})
precompile(Tuple{Type{Base.IOContext{IO_t} where IO_t<:IO}, Base.IOContext{Base.TTY}, Pair{Symbol, Module}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"##render_file#58"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"##save_test_render#77"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#59#61"{f, test, val} where val where test where f}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#60#62"{f, val} where val where f}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#63#65"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#64#66"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#67#68"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#69#70"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#71#74"{depth, normal, color} where color where normal where depth}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#72#75"{baked, pipeline_hashes, records} where records where pipeline_hashes where baked}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#73#76"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#78#79"{device, vdata, color} where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#80#81"{device, vdata, color, uv} where uv where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#82#83"{device, vdata, color} where color where vdata where device}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#84#88"{win} where win}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#85#89"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#86#92"{cycle_render, cycle} where cycle where cycle_render}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#87#93"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#cycle_f#90"}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Type{Main.var"#cycle_render#91"{cycle_f} where cycle_f}})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Main.var"##render_file#58"})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#58"}, Bool, Function, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#58"}, Bool, Module, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#58"}, Bool, Module, Function, Vararg{Function}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##render_file#58"}, Bool, Function, Function})
precompile(Tuple{Type{Base.Fix2{F, T} where T where F}, typeof(Base.isequal), Main.var"##save_test_render#77"})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#77"}, Bool, Function, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#77"}, Bool, Module, Module, Vararg{Any}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#77"}, Bool, Module, Function, Vararg{Function}})
precompile(Tuple{typeof(Base._any_tuple), Base.Fix2{typeof(Base.isequal), Main.var"##save_test_render#77"}, Bool, Function, Function})
