...
Vk.cmd_bind_vertex_buffers(cbuffer::VkCommandBuffer, buffers::AbstractVector{<:Buffer}) =
  Vk.cmd_bind_vertex_buffers(cbuffer, buffers, offset.(buffers))
Vk.cmd_bind_index_buffer(cbuffer::VkCommandBuffer, buffers::AbstractVector{<:Buffer}, T) =
  Vk.cmd_bind_index_buffer(cbuffer, buffer, offset(buffer), IndexType(T))
...
record(cbuffer::VkCommandBuffer, ::typeof(bind), buffers::AbstractVector{<:Buffer}, ::Type{<:Vertex}) =
  Vk.cmd_bind_vertex_buffers(cbuffer, pipeline, buffers)
record(cbuffer::VkCommandBuffer, ::typeof(bind), buffers::Buffer, ::Type{<:Index{T}}) where {T} =
  Vk.cmd_bind_index_buffer(cbuffer, pipeline, buffer, T)
