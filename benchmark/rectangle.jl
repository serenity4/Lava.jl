...
@btime render!(program_1($device, $vdata, $color; prog = $prog))
@profview [(render!(program_1(device, vdata, color; prog))) for _ in 1:500]
...
@btime (render!(program_2($device, $vdata, $color; prog = $prog)))
@profview [(render!(program_2(device, vdata, color; prog))) for _ in 1:500]
